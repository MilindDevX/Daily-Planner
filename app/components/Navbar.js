      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/home" className={`px-3 py-2 text-sm ${linkStyle('/')}`}>Home</Link>
            <Link href="/tasks" className={`px-3 py-2 text-sm ${linkStyle('/tasks')}`}>Tasks</Link>
            <Link href="/calendar" className={`px-3 py-2 text-sm ${linkStyle('/calendar')}`}>Calendar</Link>
            <Link href="/about" className={`px-3 py-2 text-sm ${linkStyle('/about')}`}>About</Link>
            ...
            {!user ? (
              ...
              <div className="flex items-center space-x-3">
                <span className="text-sm text-gray-700 hidden sm:inline">Hi, {user.email}</span>
                <button
